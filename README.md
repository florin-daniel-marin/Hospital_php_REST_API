...
Restful Hospital API realizat cu framework-ul php Laravel 9.0.
...
### For the first time
1.**Dependencies**  
* Install **XAMPP with PHP version 8.1.x** from https://www.apachefriends.org/download.html 
* Install Composer (dependency for Laravel) from https://getcomposer.org/download/  
...
### Creearea unui cont
**__Pentru a te putea loga, va trebui sa creezi un cont:__**  
